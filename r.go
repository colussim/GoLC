  ...
  <body>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle btn btn-link btn-primary" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                Menu
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="/download" target="downloads">Download Results</a></li>
                                <li><a class="dropdown-item" href="#" id="apiButton">API</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
    ...
    <div id="myModal" class="modal">
      <div class="modal-content">
        ...
        <p>This is some information about the API and its usage...</p>
      </div>
    </div>
